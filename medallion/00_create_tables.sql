...
-- ------------------------------------------------------------
-- BRONZE: rå, ofiltrerad, oföränderlig, append-only.
-- Allt från källfilen sparas, inklusive skräprader
-- (saknad produktkod, skräp-tillverkare, dubbletter).
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- GOLD: aggregerad, färdig statistik som dashboarden läser.
